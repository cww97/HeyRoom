 ...
 *
 * Revised from Copyright (C) 2013 Piotr Adamus
 *
...
package com.example.ydali97.allin.light.colorpicker;
...
public class MultiColorPicker extends View {
    ...
    private final int paramColorCount = 6;    // Microduino LED Board have 6 LED. Iasc CHEN
