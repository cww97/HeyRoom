...
public class tempActivity extends Activity implements View.OnClickListener {
...

    {
...

        {
            ...
            tempActivity.this.cameraDevice = cameraDevice;
...

        {
            ...
            tempActivity.this.cameraDevice = null;
...

    {
        ...
        SpannableString spanString = new SpannableString("请把你的大脸盘子放屏幕中间qwq");
...

    {
...

        {
            ...
            if (ContextCompat.checkSelfPermission(tempActivity.this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions(tempActivity.this, new String[]{Manifest.permission.CAMERA}, 1);
            } else {
            ...
            cameraDevice.createCaptureSession(Arrays.asList(surface, imageReader.getSurface()), new CameraCaptureSession.StateCallback() // ③

                    {
...

                        {
                            ...
                            Toast.makeText(tempActivity.this, "配置失败！"
